...
const flashcardData = [
  { english: 'light', german: 'das Licht (ein Licht) / leicht' },
  { english: 'thought', german: 'der Gedanke (ein Gedanke) / dachte' },
  { english: 'head', german: 'der Kopf (ein Kopf)' },
  { english: 'under', german: 'unter' },
  { english: 'story', german: 'die Geschichte (eine Geschichte)' },
  { english: 'saw', german: 'die Säge (eine Säge) / sah' },
  { english: 'left', german: 'links / verlassen' },
  { english: "don't", german: 'nicht' },
    ...
    <div className="mx-auto">
      ...
      <div className="print:hidden mb-8 p-8">
        ...
        <div className="flex justify-end mb-4">
          <ExportButton filename="EN-24-11-24" />
        </div>
